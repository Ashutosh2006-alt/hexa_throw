...
function preload(){
  ...
  grass = loadImage("images/wood.png");
...
function setup() {
  ...
  //this is the platform used in the game.
  platform1 = new Platform(width/2, height-50, width, 10);
  platform2 = new Platform(width/3+50, height/2, 250, 20);
  platform3 = new Platform(width/2+100, height/3, 300, 20);
...
function draw() {
  ...
  imageMode(CENTER);
  image(dirt,width/3+50, height/2+20, 250, 30);
  image(dirt,width/2+100, height/3+20, 300, 40);
  image(grass,width/3+50, height/2-20, 250, 60);
  image(grass,width/2+100, height/3-20, 300, 60);
  image(grass,width/2, height-100, width, 100);
  image(dirt,width/2, height, width, 100);
  image(hexaimg,hexa.position.x,hexa.position.y,40,40);
  image(sun,width-100,100,100,100);
